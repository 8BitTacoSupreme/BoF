...
Plans:
- [ ] 02-01-PLAN.md -- SQL validation service (dt-sql-parser + catalog check) + test infrastructure + Schema Registry bulk fetch
- [ ] 02-02-PLAN.md -- LLM service (Claude API, system prompt, few-shot examples, 3-retry self-correction) + mock data service
